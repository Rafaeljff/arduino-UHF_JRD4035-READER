...
//				count2++;
				...
				last_reading.toCharArray(last_reading_char, 6);
				Serial.print("ENTROU AQUIIIIIIII CARALHO");
			Serial.print(last_reading);
			Serial.print("ENTROU AQUIIIIIIII CARALHO");
			}
			myFile = SD.open(filename_box_tag, FILE_READ);
...
// read from the file until there's nothing else in it:
		...
		Serial.print("\n\nWriting to file1...");
		myFile.print("9ddde,9dddb,9ddd2,9dcd7,9d4df");
		myFile.close();
...
// read from the file until there's nothing else in it:
		...
		myFile.println("9ddde");
		myFile.println("9dddb");
		myFile.println("9dcd7");
		myFile.println("9d4df");
		myFile.close();
		Serial.println("done.");
	}
